...
class _RegisterPatientScreenState extends State<RegisterPatientScreen> {
  ...
  void register() async {
    ...
    if (res.statusCode == 200) {
      ...
      setState(() => error = "Registration failed: ${jsonDecode(res.body)["error"].toString()}");
    }
  }
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text('Phone Number', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        TextField(
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text('Date of Birth', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        TextField(
                          readOnly: true,
                          decoration: _inputDecoration(patDob == null ? 'Select your date of birth' : patDob!.toIso8601String().split("T").first).copyWith(
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text('Gender', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text('Country', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        GestureDetector(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(color: patCountryName == null ? Colors.grey : Colors.black),
                                ),
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text('City', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        DropdownButtonFormField<String>(
                        ...
                        Row(
                          children: [
                            Icon(Icons.bloodtype, color: Colors.black, size: 20),
                            const SizedBox(width: 8),
                            Text('Diabetes Type', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        DropdownButtonFormField<String>(
                          value: patDiabetesType,
                          decoration: _inputDecoration('Select your diabetes type'),
                          items: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text('Health Background (optional)', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        TextField(
                          controller: patHealthBgCtrl,
                          decoration: _inputDecoration('Enter your health background'),
                        ),
                        const SizedBox(height: 18),
                        Row(
                          children: [
                            Icon(Icons.person_pin, color: Colors.black, size: 20),
                            const SizedBox(width: 8),
                            Text('Emergency Contact Name', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        TextField(
                          controller: patEmergencyNameCtrl,
                          decoration: _inputDecoration('Enter emergency contact name'),
                        ),
                        const SizedBox(height: 18),
                        Row(
                          children: [
                            Icon(Icons.phone_in_talk, color: Colors.black, size: 20),
                            const SizedBox(width: 8),
                            Text('Emergency Contact Phone', style: TextStyle(color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        TextField(
                          controller: patEmergencyPhoneCtrl,
                          decoration: _inputDecoration('Enter emergency contact phone'),
                          keyboardType: TextInputType.phone,
                        ),
                        const SizedBox(height: 18),
                        Row(
                        ...
                        if (error.isNotEmpty)
                          Text(
                            error,
                            style: TextStyle(
                              color: error.contains("success") ? Colors.green : Colors.red,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
