      ...
      child: Column(
        ...
        children: [
          ...
          Card(
            ...
            child: Padding(
              padding:
                  const EdgeInsets.symmetric(horizontal: 12.0, vertical: 16.0), // Slightly reduced padding
              child: Column(
                children: [
                  Row(
                    children: [
          ...
          Row(
            children: [
              Icon(Icons.directions_run, color: Colors.teal, size: 20), // Smaller icon
          ...
          if (loading)
            ...
            Expanded(
              ...
              child: ListView.separated(
                separatorBuilder: (_, __) => Divider(height: 1, thickness: 0.3),
                ...
                itemBuilder: (context, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: Icon(Icons.run_circle, color: Colors.teal[300], size: 24), // Smaller icon
                      title: Text(
                        "${a['activity_type']} (${a['duration_minutes']} min)",
                        style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14), // Smaller font
                      ),
                      subtitle: Text(
                      ...
                      trailing: IconButton(
                        icon: Icon(Icons.delete, color: Colors.red[300], size: 20), // Smaller icon
                        tooltip: "Delete Log",
                        onPressed: () async {
