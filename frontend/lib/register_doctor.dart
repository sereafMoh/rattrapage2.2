                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          decoration: _inputDecoration(specialties.isEmpty
                        ...
                        TextField(
                          ...
                          decoration:
                              _inputDecoration('Enter your clinic/hospital name'),
                          textInputAction: TextInputAction.next,
                        ),
                        const SizedBox(height: 18),
                        // Country
                        ...
                        DropdownButtonFormField<String>(
                          value: docCity,
                          decoration: _inputDecoration(docCountryIso2 == null
                        ...
                        Row(
                          children: [
                            Icon(Icons.verified_user,
                                color: Colors.black, size: 20),
                            const SizedBox(width: 8),
                            Text('Professional License/ID Number',
                                style: TextStyle(
                                    color: Colors.black, fontSize: 14)),
                          ],
                        ),
                        ...
                        TextField(
                          ...
                          decoration:
                              _inputDecoration('Enter your license/ID number'),
                          textInputAction: TextInputAction.next,
                        ),
                        const SizedBox(height: 18),
                        // Password
                        ...
                        TextField(
                          ...
                          decoration:
                              _inputDecoration('Confirm your password').copyWith(
                            suffixIcon: IconButton(
                              icon: Icon(
